...
if '__main__' == __name__:
    ...
    def showMenu():
        ...
        print('1- Gerenciar médico')    #dpois add - crud- 
        print('2- Pegar senha')
        print('3- Ver médicos disponíveis')
        print('4- Ver fila preferencial')   #
        print('5- Ver fila convencional')   #pedir dentro desse de qual especialidade ele quer
        print('6- Chamar paciente para ser atendido')   #escolher a especialidade
        print('0- Sair')
